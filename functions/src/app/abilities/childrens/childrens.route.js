...
router.post('/', [auth_middleware_1.AuthMiddleware, abilities_middleware_1.default], childrens_controller_1.CreateController);
router.get('/:children_id', (0, app_middleware_1.CacheMiddleWare)('5 minutes'), childrens_controller_1.FindOneController);
router.patch('/:children_id', [auth_middleware_1.AuthMiddleware, abilities_middleware_1.default], childrens_controller_1.UpdateController);
router.delete('/:children_id', auth_middleware_1.AuthMiddleware, childrens_controller_1.RemoveController);
